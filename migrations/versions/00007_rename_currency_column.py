...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column("accounts", sa.Column("currency_id", sa.VARCHAR(), autoincrement=False, nullable=True))
    op.drop_constraint("accounts_currency_code_fkey", "accounts", type_="foreignkey")
    op.create_foreign_key("accounts_currency_id_fkey", "accounts", "currencies", ["currency_id"], ["code"])
